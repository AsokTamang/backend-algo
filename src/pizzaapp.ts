...
addToArray<Order>(orderQueue, {
  ...
  pizza: menu[2]!,
  status: "ordered",
}); //here as we are using generic function in addToArray function, we also must define the type of argument that is passed in this function if the passed argument's type
//must be some specific types or values like here status must be 'ordered' | 'completed'
